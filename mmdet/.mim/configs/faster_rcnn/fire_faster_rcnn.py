...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='Train_Images/BBoxJson/fold_3_train_20.json',
        data_prefix=dict(img='Train_Images/')))
val_dataloader = dict(
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='Val_Images/BBoxJson/fold_3_val_20.json',
...
test_dataloader = dict(
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='Test_Images/BBoxJson/fold_3_test_20.json',
        data_prefix=dict(img='Test_Images/')))

# Modify metric related settings
val_evaluator = dict(ann_file=data_root + 'Val_Images/BBoxJson/fold_3_val_20.json')
test_evaluator = dict(ann_file=data_root + 'Test_Images/BBoxJson/fold_3_test_20.json')
