...
class BBoxHead(BaseModule):
    ...
    def __init__(self,
        ...
        self.loss_clus = MODELS.build(loss_clus)
    ...
    def loss_feat_clusters(self,pos_embbeds,neg_embbeds)-> torch.Tensor:
        return self.loss_clus(pos_embbeds,neg_embbeds)
